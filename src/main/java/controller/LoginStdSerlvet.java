...
/**
 * Servlet implementation class LoginStdSerlvet
 */
@WebServlet("/LoginStd")
public class LoginStdSerlvet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement preparedStatement1 =con.prepareStatement("SELECT User_Username FROM mydb.student WHERE User_Username=?");
